      ...
      <div>
            ...
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Make sure this description is after deep consideration
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-full">
            <div className="px-4 sm:px-0">
              <h3 className="text-2xl font-bold leading-6 text-gray-900">Create NFT Metadata</h3>
            </div>
          </div>
          <div className="mt-5 md:mt-0 md:col-span-full">
            <form>
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-10 bg-yellow-100 space-y-6 sm:p-6">
                  <div>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-300">
                          <label
                            htmlFor="file-upload"
                            className="relative cursor-pointer bg-yellow-100 rounded-md font-medium text-blue-300 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
                          >
                ...
                <div className="px-4 py-3 bg-yellow-100 text-right sm:px-6">
                  <button
                    onClick={uploadMetadata}
                    type="button"
                    className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Upload
                  </button>
                </div>
